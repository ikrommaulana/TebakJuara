                    ...
                    <form role="form" method="post">
                        <fieldset>
                            <div class="form-group">
                                <h4 style="color:#fff;text-align:center;">Lengkapi Data Anda</h4>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input class="form-control" placeholder="Username" value="<?= $user['username']; ?>" name="username" type="text" autofocus="">
                            </div>
                            <div class="form-group">
                            ...
                            <input name="submit" value="Register" type="submit" class="btn btn-primary btn-block">
