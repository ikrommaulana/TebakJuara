...
<body id="page-top" data-spy="scroll">
    ...
    <div style="padding-top:50px">
        <div align="center"><h3 style="color:#000;">Pilih klub yang akan menjadi juara <b>End Season</b> Premier League 2017/2018</h3><br/><br/></div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" name="season" class="form-control" value="full" />
